...
const SeriesCollapsible = () => {
  return (
    <Collapsible.Root className="my-4 flex flex-col divide-y divide-secondary overflow-clip rounded-md border border-secondary">
      <Collapsible.Trigger className="group flex items-center justify-between gap-3 bg-secondary p-4">
        <p className="m-0 text-left font-medium leading-tight">
      ...
      <Collapsible.Content className="bg-secondary px-4">
        <p className="text-balance text-sm leading-normal">
