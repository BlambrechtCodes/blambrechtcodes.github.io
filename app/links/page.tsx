    ...
    <>
      <div className="flex flex-col gap-16 md:gap-24 max-w-lg mx-auto">
        <div className="flex animate-in flex-col gap-8">
          ...
          >
            <h1 className="text-2xl font-bold tracking-tight">Brendan Lambrecht</h1>
            <p className="mx-auto max-w-sm text-secondary">
              Aspiring software engineer and content creator — here are my links where you can connect with me.
            </p>
          </div>
        </div>
        <ul
