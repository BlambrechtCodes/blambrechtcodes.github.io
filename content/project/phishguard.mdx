...
url: "https://www.github.com/blambrechtCodes/PhishGuard"
...
My initial approach was to create a Chrome extension that would analyze URLs in real-time as users browsed the web. I spent weeks learning about browser extension development, studying the Chrome API, and designing a system that could intercept and analyze web requests.
...
<Image
  ...
  src="/blog/phishguard/ChromeArch.png"
/>
...
<Image
  ...
  src="/blog/phishguard/FullStack.png"
/>
...
<Image
  ...
  src="/blog/phishguard/MLmodel.png"
/>
...
> "The best security tools are those that make protection accessible to everyone, not just experts." - Project Philosophy
...
<Image
  ...
  src="/blog/phishguard/PhishAttack.png"
/>
...
With PhishGuard's analysis, you would receive this warning before entering any sensitive information:

<Image
  contained
  width={800}
  height={400}
  caption="User interface showing clear warning to the user"
  src="/blog/phishguard/6.png"
/>

This early detection could prevent:
- **Identity Theft**: Your login credentials remain secure
- **Financial Loss**: No access to linked payment methods
- **Data Breach**: Your personal information stays protected
- **Account Takeover**: Your university accounts remain under your control
...
<Image
  ...
  width={800}
  height={400}
  caption="Real-time analysis dashboard with detailed results"
  src="/blog/phishguard/8.png"
/>
...
<Image
  ...
  width={800}
  height={400}
  caption="Mobile interface showing responsive design"
  src="/blog/phishguard/9.png"
/>
...
After watching the demo, you can experience PhishGuard firsthand by visiting the live application. The interface is designed to be intuitive and accessible, whether you're a cybersecurity expert or someone just looking to stay safe online.

The video serves as both a technical showcase and a user guide, demonstrating that powerful security tools don't have to be complex or intimidating. PhishGuard proves that cutting-edge machine learning can be made accessible to everyone, helping create a safer internet for all users.
...
The system's modular architecture makes it easy to extend and improve, while its comprehensive feature set provides robust protection against modern phishing threats. Most importantly, PhishGuard serves as an educational tool, helping users understand the characteristics of malicious websites and make more informed decisions about their online security.
